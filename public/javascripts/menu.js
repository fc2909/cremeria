...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataCreditos2').html(html); 
               $('.contCataCreditos2P').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirCreditos').style.display = 'block';
...
function loadCreditos3(lista){ //por mayoreo
  var longi2= parseFloat(scv)-parseFloat(scv2);
          prodTotales = new Array(longi2);
          credi=0;
          boni=0;
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataCreditos3').html(html); 
               $('.contCataCreditos3P').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirCreditos').style.display = 'block';
      calcularTotales();     
              }
...
$('.TotalesCredP').html(htmlp); 
   document.getElementById('loader').style.display = 'none';

             }

function loadCreditos4(lista){ //por mayoreo
  var longi2= parseFloat(scv)-parseFloat(scv2);
          prodTotales = new Array(longi2);
          credi=0;
          boni=0;
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataCreditos4').html(html); 
               $('.contCataCreditos4P').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirCreditos').style.display = 'block';
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataBonificacion2').html(html); 
               $('.contCataBonificacion2p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirBonificacionTotal').style.display = 'block';
...
function loadBonificacion3(lista){ //por mayoreo
  var longi2= parseFloat(scv)-parseFloat(scv2);
          prodTotales = new Array(longi2);
          credi=0;
          boni=0;
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataBonificacion3').html(html); 
               $('.contCataBonificacion3p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirBonificacionTotal').style.display = 'block';
      calcularTotales2();     
              }
...
htmlp+='<tr class="grisclaro" style="font-size:8px;   " class=" text-right" ><td><strong>TOTALES</strong></td> <td class=" text-center" ><strong></strong></td><td></td>'+htmlT2+' </tr>';
//$('.TotalesCred').html(htmlT2); 
$('.totalBonp').html(htmlp); 
   document.getElementById('loader').style.display = 'none';
        
             }

function loadBonificacion4(lista){ //por mayoreo
  var longi2= parseFloat(scv)-parseFloat(scv2);
          prodTotales = new Array(longi2);
          credi=0;
          boni=0;
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataBonificacion4').html(html); 
               $('.contCataBonificacion4p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirBonificacionTotal').style.display = 'block';
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataVentaNomina2').html(html); 
               $('.contCataVentaNomina2p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirVentaTotal').style.display = 'block';
...
function loadVentaNomina3(lista){ //por mayoreo
  var longi2= parseFloat(scv)-parseFloat(scv2);
          prodTotales = new Array(longi2);
          credi=0;
          boni=0;
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataVentaNomina3').html(html); 
               $('.contCataVentaNomina3p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirVentaTotal').style.display = 'block';
      calcularTotales3();     
              }
...
htmlp+='<tr class="grisclaro" style="font-size:8px;   " class=" text-right" ><td><strong>TOTALES</strong></td> <td class=" text-center" ><strong></strong></td><td></td>'+htmlT2+' </tr>';
//$('.TotalesCred').html(htmlT2); 
$('.totalVentp').html(htmlp); 
   document.getElementById('loader').style.display = 'none';
        
             }

function loadVentaNomina4(lista){ //por mayoreo
  var longi2= parseFloat(scv)-parseFloat(scv2);
          prodTotales = new Array(longi2);
          credi=0;
          boni=0;
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataVentaNomina4').html(html); 
               $('.contCataVentaNomina4p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirVentaTotal').style.display = 'block';
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataNoVenta2').html(html); 
               $('.contCataNoVenta2p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirNoVentaTotal').style.display = 'block';
...
function loadNoVentaNomina3(lista){ //por mayoreo
  var longi2= parseFloat(scv)-parseFloat(scv2);
          prodTotales = new Array(longi2);
          credi=0;
          boni=0;
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataNoVenta3').html(html); 
               $('.contCataNoVenta3p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirNoVentaTotal').style.display = 'block';
      calcularTotales33();     
              }
...
function loadNoVentaNomina4(lista){ //por mayoreo
  var longi2= parseFloat(scv)-parseFloat(scv2);
          prodTotales = new Array(longi2);
          credi=0;
          boni=0;
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataNoVenta4').html(html); 
               $('.contCataNoVenta4p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirNoVentaTotal').style.display = 'block';
...
if(lista[j].n1 !=(undefined||NaN||""||null)){
           creditosT += (parseFloat(lista[j].n1));
          }
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataMerma2').html(html); 
               $('.contCataMerma2p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirMermaTotal').style.display = 'block';
...
function loadMermaNomina3(lista){ //por mayoreo
  var longi2= parseFloat(scv)-parseFloat(scv2);
          prodTotales = new Array(longi2);
          credi=0;
          boni=0;
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataMerma3').html(html); 
               $('.contCataMerma3p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirMermaTotal').style.display = 'block';
      calcularTotales55();     
              }
...
htmlp+='<tr class="grisclaro" style="font-size:8px;   " class=" text-right" ><td><strong>TOTALES</strong></td> <td class=" text-center" ><strong></strong></td><td></td>'+htmlT2+' </tr>';
//$('.TotalesCred').html(htmlT2); 
$('.totalMermaNomina').html(htmlp); 
   document.getElementById('loader').style.display = 'none';
        
             }

function loadMermaNomina4(lista){ //por mayoreo
  var longi2= parseFloat(scv)-parseFloat(scv2);
          prodTotales = new Array(longi2);
          credi=0;
          boni=0;
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo2PF').html(titulos); 
               $('.tituloP').html(titulosP); 
               $('.contCataMerma4').html(html); 
               $('.contCataMerma4p').html(htmlP); 
               //$('.contCataMayoreoPF').html(htmlP); 
        document.getElementById('imprimirMermaTotal').style.display = 'block';
...
function loadVentaDiariaMayoreoNominaFaltante(lista){ //por mayoreo
  ...
  for(var i=0; i < arrGlobalRuta.length; i++) {
       ...
       if(arrGlobalF[j].id!=(undefined||NaN||""||null)){
        ...
        if(arrGlobalEmpleados[hh2].km!=(undefined||NaN||""||null)){
          f_Ahorro = arrGlobalEmpleados[hh2].km;
          }
       if(arrGlobalEmpleados[hh2].n1!=(undefined||NaN||""||null)){
          ret = arrGlobalEmpleados[hh2].n1;
          }else{ret=0;}
          if(arrGlobalEmpleados[hh2].infonavit!=(undefined||NaN||""||null)){
           infonavit = arrGlobalEmpleados[hh2].infonavit;
          }else{infonavit=0;}
          if(arrGlobalF[j].cobrado !=(undefined||NaN||""||null)){
...
mermaT += 0;
          ...
          if(arrGlobalF[j].otros!=(undefined||NaN||"")){
bonificacionTotal += parseFloat(arrGlobalF[j].otros);
}else{
bonificacionTotal += 0;
...
if(f_Ahorro=="F"){f_Ahorro=100;}
  encuentra=1; 
identificacion= '<tr style="font-size:12px; " class="seleccionar text-center" onclick="upNomina('+ret+', '+f_Ahorro+', '+infonavit+', '+arrGlobalF[j].id+', '+faltanteT+','+arrGlobalEmpleados[hh2].id+', '+mermaT+','+bonificacionTotal+', '+arrGlobalEmpleados[hh2].l_bon+','+mermaH+' );" ><td >' + ruta3  + '</td><td >'+t_ventas[arrGlobalF[j].tipo-1]+'</td> <td >' + arrGlobalEmpleados[hh2].nombre_Emple + '</td>';
identificacionP= '<tr style="font-size:8px; " class="text-center" ><td><strong> ' + ruta3  + '</strong></td><td ><strong>'+t_ventas[arrGlobalF[j].tipo-1]+'</strong></td> <td ><strong>' +  arrGlobalEmpleados[hh2].nombre_Emple + '</strong></td>';
     ...
     if(encuentra==0&&arrGlobalEmpleados[hh2].reingresos>10){
          for(var i=0; i < arrGlobalRuta.length; i++) {
       if(arrGlobalRuta[i].id==arrGlobalEmpleados[hh2].ruta){
          ruta3=arrGlobalRuta[i].nombre;
          rutas=arrGlobalEmpleados[hh2].ruta;
...
if(arrGlobalEmpleados[hh2].km!=(undefined||NaN||"")){
          f_Ahorro = arrGlobalEmpleados[hh2].km;
          }

if(arrGlobalEmpleados[hh2].n1!=(undefined||NaN||"")){
          ret = arrGlobalEmpleados[hh2].n1;
          }else{ret=0;}
          if(arrGlobalEmpleados[hh2].infonavit!=(undefined||NaN||"")){
           infonavit = arrGlobalEmpleados[hh2].infonavit;
          }else{infonavit=0;}
...
identificacion= '<tr style="font-size:12px; " class="seleccionar text-center" onclick="upNomina('+ret+', '+f_Ahorro+', '+infonavit+', '+arrGlobalF[j].id+', '+faltanteT+', '+arrGlobalEmpleados[hh2].id+', '+mermaT+','+bonificacionTotal+', '+arrGlobalEmpleados[hh2].l_bon+' );" ><td >' + ruta3  + '</td><td >'+t_ventas[arrGlobalF[j].tipo-1]+'</td> <td >' + arrGlobalEmpleados[hh2].nombre_Emple + '</td>';
identificacionP= '<tr style="font-size:8px; " class="text-center" ><td><strong> ' + ruta3  + '</strong></td><td ><strong>'+t_ventas[arrGlobalF[j].tipo-1]+'</strong></td> <td ><strong>' +  arrGlobalEmpleados[hh2].nombre_Emple + '</strong></td>';
...
identificacionP= '<tr style="font-size:10px; " class="text-center" ><td><strong> ' + ruta3  + '</strong></td><td ><strong>'+t_ventas[arrGlobalF[j].tipo-1]+'</strong></td> <td ><strong>' +  arrGlobalEmpleados[hh2].nombre_Emple + '</strong></td>';
...
var su=0;
 var pago=0;
        ...
        prodN=0;
         ...
         if(infonavit==null){infonavit=0;}
         if(ret==null){ret=0;}
         if(faltanteT==undefined)faltanteT=0;
         if(faltanteT>0)faltanteT=0;
         if(faltanteT<0)faltanteT=(faltanteT)*(-1);
        //  alert("pago: "+pago+" f: "+f_Ahorro+" Faltante: "+faltanteT+" ret: "+ret+" inf: "+infonavit);
         var totalNomina = parseFloat(pago)-parseFloat(mermaT)-parseFloat(f_Ahorro)-parseFloat(faltanteT)-parseFloat(ret)-parseFloat(infonavit);
...
if(f_Ahorro=="F"){f_Ahorro=100;}
  encuentra=1; 
identificacion= '<tr style="font-size:12px; " class="seleccionar text-center" ><td >' + ruta3  + '</td><td >'+t_ventas[arrGlobalF[j].tipo-1]+'</td> <td >' + arrGlobalF[j].nombre + '</td>';
identificacionP= '<tr style="font-size:10px; " class="text-center" ><td><strong> ' + ruta3  + '</strong></td><td ><strong>'+t_ventas[arrGlobalF[j].tipo-1]+'</strong></td> <td ><strong>' +  arrGlobalEmpleados[hh2].nombre_Emple + '</strong></td>';
...
function loadVentaDiariaPagoFijoNomina(lista){ //
          prodTotales = new Array(arrGlobalCategoria.length);
          credi=0;
          boni=0;
          s_vent=0;
 ...
 var pago=0;
      ...
      for(var hh2=0;hh2<arrGlobalEmpleados.length; hh2++){
        if(arrGlobalEmpleados[hh2].reingresos!=0&&arrGlobalEmpleados[hh2].tipo==2&&arrGlobalEmpleados[hh2].estado==1){
          pago = arrGlobalEmpleados[hh2].reingresos;
       for(var j=0;j<arrGlobalF.length; j++){
...
if(f_Ahorro=="F"){f_Ahorro=100;}
  encuentra=1; 
identificacion= '<tr style="font-size:12px; " class="seleccionar text-center" onclick="" ><td >' + ruta3  + '</td><td ></td> <td >' + arrGlobalEmpleados[hh2].nombre_Emple + '</td>';
identificacionP= '<tr style="font-size:10px; " class="text-center" ><td><strong> ' + ruta3  + '</strong></td><td ><strong></strong></td> <td ><strong>' +  arrGlobalEmpleados[hh2].nombre_Emple + '</strong></td>';
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.tituloNomina').html(titulos); 
               $('.titulo2P').html(titulosP); 
               $('.contCataPagoFijoN').html(html); 
               $('.contCataPagoFijoP').html(htmlP); 
              }
...
pasa2=1;
  encuentra=1; 
identificacion= '<tr style="font-size:12px; " class="seleccionar text-center" ><td >' + ruta3  + '</td><td >'+t_ventas[arrGlobalF[j].tipo-1]+'</td> <td >' + arrGlobalF[j].nombre + '</td><td >$ ' + formatoMoneda1(credits)+ '</td> <td >$ ' + formatoMoneda1(bonificacionT)+ '</td>  <td > % ' + formatoMoneda1(porcentajeTotal) + '</td> <td >$ ' + formatoMoneda1(t_venta_mercaT)+ '</td>';
identificacionP= '<tr style="font-size:12px; " class="text-center" ><td><strong> ' + ruta3  + '</strong></td><td ><strong>'+t_ventas[arrGlobalF[j].tipo-1]+'</strong></td> <td ><strong>' +  arrGlobalEmpleados[hh2].nombre_Emple + '</strong></td><td class="text-right">$ ' + formatoMoneda1(credits) + '</td> <td class="text-right">$ ' + formatoMoneda1(bonificacionT) + '</td>  <td class="text-right"> % ' + formatoMoneda1(porcentajeTotal) + '</td> <td class="text-right">$ ' + formatoMoneda1(t_venta_mercaT) + '</td>';
...
function loadVentaDiariaOtrosProductos(lista){ //por mayoreo
          prodTotales = new Array(100);
          credi=0;
          boni=0;
          s_vent=0;
...
identificacion= '<tr style="font-size:12px; " class="seleccionar text-center" ><td >PEDIDOS</td><td ></td> <td >' + arrGlobalF[j].nombre + '</td><td >$ ' + formatoMoneda1(credits)+ '</td> <td >$ ' + formatoMoneda1(bonificacionT)+ '</td>  <td > % ' + formatoMoneda1(porcentajeTotal) + '</td> <td >$ ' + formatoMoneda1(t_venta_mercaT)+ '</td>';
identificacionP= '<tr style="font-size:12px; " class="text-center" ><td><strong> PEDIDOS</strong></td><td ><strong></strong></td> <td ><strong>' +  arrGlobalEmpleados[hh2].nombre_Emple + '</strong></td><td class="text-right">$ ' + formatoMoneda1(credits) + '</td> <td class="text-right">$ ' + formatoMoneda1(bonificacionT) + '</td>  <td class="text-right"> % ' + formatoMoneda1(porcentajeTotal) + '</td> <td class="text-right">$ ' + formatoMoneda1(t_venta_mercaT) + '</td>';
...
////////////////////////////////////Titulos////////////////////////////////////////////
for(var hh3=0;hh3<arrGlobalEmpleados2.length; hh3++){
        if(arrGlobalEmpleados2[hh3].km==1){

for(var h2=0;h2<lista2.length; h2++){
     if(arrGlobalEmpleados2[hh3].id==lista[h].vendedor&&&&pasa2==1&&lista2[h2].fecharecepcion!=null&&0==lista2[h2].merma&&(scv+1)==lista2[h2].sfc&&year==((lista2[h2].fechadespachof).substring(0,4))){
                  cambio=lista2[h2].idProducto;
                  nombre=lista2[h2].descripcionventa;
                for(var p=0;p< prodNum.length; p++){
                  if(prodNum[p]==cambio){
...
htmlP+='<tr class="gris"><td colspan="'+renglon+'" style="font-size:6px;" class=" text-center">.</td></tr>';
              ...
              if(html==undefined){html='';}else{
               $('.titulo6').html(titulos); 
               $('.titulo6P').html(titulosP); 
...
function addCategoria(){
          ...
          var json = {nombre: nombre, descripcion: descripcion, jerarquia: jerarquia};
              addRegistro3(json, 'categorias', loadCategorias);
...
function pago(tipo){
  if(tipo==1){
        document.getElementById('cantidadPago').style.display = 'none';

  }else{
        document.getElementById('cantidadPago').style.display = 'block';
...
function addVendedor(){
  ...
  var tipoPago = $("#modalVendedor .tipoPago").val();
  var reingresos;
  if(tipoPago==1){
    reingresos=0;
  }else{
    reingresos=$("#modalVendedor .cantidadPago1").val();
  }
...
today_v = year3+'-'+mes+'-'+dia;
var diasemaD= new Date((parseInt(mes))+' '+parseInt(dia)+' ,'+parseInt(year3));
   var diaD=(diasemaD.getUTCDay());
if(diaD==0)diaD=7;
$('.tituloPantalla').html('<h3 class="ventas impre"> VENTAS </h3><p style="color:yellow;">( '+dias[diaD -1]+', '+dia+' DE '+months[parseInt(mes)]+' DEL '+year+' )</p>');   


 document.getElementById('loader').style.display = 'block';
 saberSemana(parseInt(dia), (parseInt(mes)-1) ,parseInt(year3));
          scv=noSemana;
...
function upComision(){
          ...
          var json = {n1:n1, n2:n2, n3:n3, n4:n4};
              upRegistro3(idGlobal,json, 'categorias', loadComision);
...
function upNominaE(ret, fA, infonavit, id,fOS){
...
$('#modalNominaE').modal('show');
$('#modalNominaE #nombreNominaE').html(nombreNomina);
$('#modalNominaE .retE').val(ret);
$('#modalNominaE .fAE').val(fA);
$('#modalNominaE .infonavitE').val(infonavit);
$('#modalNominaE .idNominaFE').val(id);
$('#modalNominaE .faltanteOSobranteE').val(fOS);

}
function upNomina(ret, fA, infonavit, id,fOS,id2,mermaTF,bon1,bon2, mermaH){
...
$('#modalNomina .idNominaFE').val(id2);
$('#modalNomina .faltanteOSobrante').val(fOS);
$('#modalNomina .mermaTF').val(mermaTF);
$('#modalNomina .bonificacionTF').val(n2);
$('#modalNomina .mermaTF2').val(mermaTF);
$('#modalNomina .mermaTFH').val(mermaH);
...
var idNominaTE = $('#modalNomina .idNominaFE').val();
var n1 =$('#modalNomina .ret').val();
var n11 = $('#modalNomina #retiro').val();
var km =$('#modalNomina .fA').val();
var infonavit =$('#modalNomina .infonavit').val();
var cobrado = $('#modalNomina .faltanteOSobrante').val();
var mermaTF = $('#modalNomina .mermaTF').val();
var bonificacionTF = $('#modalNomina .bonificacionTF').val();
var mermaTF2 = $('#modalNomina .mermaTF2').val();
var n5 = $('#modalNomina .mermaTFH').val();
if(km=="")km=0;
if(n1=="")n1=0;
...
var json2 = {n5:n5};
var jsonC = {where:{ruta:ruta}}
upRegistroA2(idNominaT,json2,jsonC,  'ventaspasada', loadVentasp4);
...
var idNominaT = $('#modalNominaE .idNominaFE').val();
var n1 =$('#modalNominaE .retE').val();
var km =$('#modalNominaE .fAE').val();
var infonavit =$('#modalNominaE .infonavitE').val();
if(n1=="")n1=0;
if(infonavit=="")infonavit=0;
if(km=="")km=0;
closeModalNomE();
...
upRegistro(idNominaT, json,'empleados',  loadEmpleados1);
getFunction('empleados', "Ocurrio un error al cargar el formulario, reintentar más tarde.", loadEmpleados1);
...
function selectVendedores(id){
  ...
  for(var a=0; a<arrGlobal.length; a++){
    if(arrGlobal[a].id == id){
       ...
       if(arrGlobal[a].reingresos!=0){

       $("#modalVendedor .cantidadPago1").val(arrGlobal[a].reingresos);
        document.getElementById('cantidadPago').style.display = 'block';
       $("#modalVendedor .tipoPago").val(2);

       }else{
        document.getElementById('cantidadPago').style.display = 'none';
       $("#modalVendedor .tipoPago").val(1);
...
getFunction('ventaspasada', "Ocurrio un error al cargar el formulario, reintentar más tarde.", loadCreditos4);
getFunction('ventaspasada', "Ocurrio un error al cargar el formulario, reintentar más tarde.", loadCreditos2);
getFunction('ventaspasada', "Ocurrio un error al cargar el formulario, reintentar más tarde.", loadCreditos3);
       document.getElementById('loader').style.display = 'block';
...
var sfc = (scv+1)+"";
  ...
  if(scv != ""){
      ...
      executeFunctionDone(json, 'ventadiaria', "Ocurrio un error al cargar el formulario, reintentar más tarde. ", loadVentaDiariaOtrosProductos);
...
var diaEsp=nomdia2.getUTCDay();
if(nomdia2.getUTCDay()==0){diaEsp=7}
var fecha2E = "<strong>"+dias[diaEsp-1]+", "+ daycambiomodalE + " DE " + months[parseInt(monthcambiomodalE)] + " DEL " + yearcambiomodalE+"</strong>";

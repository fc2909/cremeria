...
ActiveRecord::Schema.define(version: 20190327035501) do
  ...
  create_table "pagares", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "nombre"
    t.integer  "activo"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "remisions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "folio"
    t.string   "importe"
    t.string   "ppd"
    t.string   "fc"
  ...
  create_table "super_categoria", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "nombre"
    t.string   "descripcion"
    t.string   "n1"
    t.string   "n2"

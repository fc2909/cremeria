...
var datep = new Date();
var todayp = date.getDay();
var dayp = date.getDate();
var monthp = date.getMonth() + 1;
var yyp = date.getYear();
var yearp = (yy < 1000) ? yy + 1900 : yy;
 var nomdiap = new Date((parseInt(month))+' '+parseInt(day)+' ,'+parseInt(year));

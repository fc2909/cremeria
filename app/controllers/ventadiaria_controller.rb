class VentadiariaController < ApplicationController
	...
	private
		...
		def model_params
			params.permit(:id, :idProducto, :descripcionventa, :piezas, :peso,  :medida, :piezasv, :pesov, :precioUnitario, :valorMercancia, :cantidadregresada, :venta, :horadespacho, :horarecepcion, :empleado, :vendedor, :ruta, :fechadespacho, :fecharecepcion, :user, :dc, :sc, :dfc, :sfc, :fechadespachof, :fecharecepcionf, :merma, :tipoP, :semana)

...
function updateListaMerma(){
    ...
    var html ="";
     var add = "'addM'";
    var encontrado = 0;
    var peso = ' <label class="letras impre" >PESO</label><input type="text" id="pesoM" class="pesoM form-control clear  impre" onchange="document.getElementById('+add+').focus();" placeholder="">';
